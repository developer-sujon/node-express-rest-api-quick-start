...
```bash
git clone --depth 1 https://github.com/developer-sujon/node-express-rest-api-quick-start.git
cd node-express-rest-api-quick-start
npx rimraf ./.git
```
