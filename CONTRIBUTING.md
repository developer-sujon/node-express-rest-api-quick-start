...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/developer-sujon/node-express-rest-api-quick-start#manual-installation) section in README.md)
